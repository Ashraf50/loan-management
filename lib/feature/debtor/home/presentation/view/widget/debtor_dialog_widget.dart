...
class DebtorDialogWidget extends StatefulWidget {
  const DebtorDialogWidget({super.key});

  @override
  State<DebtorDialogWidget> createState() => _DebtorDialogWidgetState();
}

class _DebtorDialogWidgetState extends State<DebtorDialogWidget> {
